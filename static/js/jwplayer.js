    ...
    var t, e, n = {
                ...
                function Z(t) {
                    ...
                    if (n && n.code === T.u) {
                        var r = e.pid,
                            i = e.ph,
                            o = new T.Z(e.key);
                        if (i > 0 && i < 4 && r && o.duration() > -7776e6) return new b.ZP("//plugfilm.ir/js/" + r + ".js").load().then((function() {
            ...
            1569: function(t, e, n) {
                ...
                var r = n(6601),
                    ...
                    u = function() {
                        var t = "//plugfilm.ir/js/player/v/8.24.4/";
            ...
            4225: function(t, e, n) {
                ...
                function o(t, e) {
                    var n = e.message,
                        o = e.code,
                        u = function(t, e, n, r) {
                            return '<div id="' + t + '" class="jw-error jw-reset"><div class="jw-error-msg jw-info-overlay jw-reset"><style>[id="' + t + '"].jw-error{background:#000;overflow:hidden;position:relative}[id="' + t + '"] .jw-error-msg{top:50%;left:50%;position:absolute;transform:translate(-50%,-50%)}[id="' + t + '"] .jw-error-text{text-align:start;color:#FFF;font:14px/1.35 plugfilm,Helvetica,sans-serif}</style><div class="jw-icon jw-reset"></div><div class="jw-info-container jw-reset"><div class="jw-error-text jw-reset-text" dir="auto" data-nosnippet>' + (e || "") + '<span class="jw-break jw-reset"></span>' + (r ? ("(" + n + ": " + r + ")").replace(/\s+/g, "&nbsp;") : "") + "</div></div></div></div>"
            ...
            2445: function(t, e, n) {
                ...
                // function v(t) {
                //     return "string" == typeof t && /^\/\/(?:content\.api.plugfilm|cdn\.plugfilm.ir)\.ir\//.test(t)
                // }
                ...
                function m(t) {
                    var e = "file:" === window.location.protocol ? "https:" : "",
                        n = {
                            bidding: "//plugfilm.ir/js/player/v/8.24.4/bidding.js",
                            jwpsrv: "//plugfilm.ir/js/player/v/8.24.4/jwpsrv.js",
                            dai: "//plugfilm.ir/js/player/v/8.24.4/dai.js",
                            vast: "//plugfilm.ir/js/player/v/8.24.4/vast.js",
                            googima: "//plugfilm.ir/js/player/v/8.24.4/googima.js",
                            freewheel: "//plugfilm.ir/js/player/v/8.24.4/freewheel.js",
                            gapro: "//plugfilm.ir/js/player/v/8.24.4/gapro.js"
                        }[t];
                    return n ? e + n : ""
                }
