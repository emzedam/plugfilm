  ...
  <section class="movies-slider my-20 px-6 overflow-hidden relative">
    ...
    >
      <div class="flex items-center justify-between">
        <h2 class="lg:text-2xl text-white">دوبله ها</h2>
      ...
      <div class="slider-btn pr-0 relative overflow-hidden items-center flex">
        ...
        >
          <div class="prev2 w-10 cursor-pointer">
            <i class="fa-solid fa-chevron-right"></i>
          </div>
          <div class="next2 w-10 cursor-pointer">
...
export default {
  ...
  async mounted() {
    await this.$nextTick();
    new Swiper(this.$refs.swiper_dubleha, {
      slidesPerView: 6,
      loop: false,
      dir: "ltr",
      spaceBetween: 15,
