<template>
  <div class="lg:px-0 px-4">
    ...
    <div class="w-full max-w-7xl mx-auto mt-28 mb-6">
      ...
      >
      شما در حال دیدن دسته {{ catname }} هستید
      </h2>
    </div>
          ...
          >
            ...
            >
              ...
              <figcaption>
                ...
                <div
                  class="play absolute place-content-center inset-0 flex items-center justify-center z-10"
                >
                  <Play2 class="fill-white w-10" />
                </div>
                <div
                  class="category absolute bottom-4 z-10 text-gray-400 flex items-center justify-center inset-x-0 text-xs"
                >
                  <ul class="inline-flex gap-x-4 list-disc">
                    <li
